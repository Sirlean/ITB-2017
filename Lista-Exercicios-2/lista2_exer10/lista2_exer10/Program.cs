...
namespace lista2_exer10
{
    class Program
    {
        static void Main(string[] args)
        {
            //Elabore uma aplicação que receba quatro números inteiros e apresentar os números que são
            //divisíveis por 2 e 3 simultaneamente.
            ...
            string numerosDivisiveisPor2e3 = "";
            ...
            {
                numerosDivisiveisPor2e3 = numerosDivisiveisPor2e3 + " " + n1;
            }

            if ((n2 % Divisor2) == 0 && (n2 % Divisor3) == 0)
            {
                numerosDivisiveisPor2e3 = numerosDivisiveisPor2e3 + " " + n2;
            }
            if ((n3 % Divisor2) == 0 && (n3 % Divisor3) == 0)
            {
                numerosDivisiveisPor2e3 = numerosDivisiveisPor2e3 + " " + n3;
            }
            if ((n4 % Divisor2) == 0 && (n4 % Divisor3) == 0)
            {
                numerosDivisiveisPor2e3 = numerosDivisiveisPor2e3 + " " + n4;
            }

            //Saida
            Console.WriteLine("Os números divisíveis por 2 e 3 são " + numerosDivisiveisPor2e3);
            Console.ReadLine();
